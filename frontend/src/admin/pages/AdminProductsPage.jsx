...
import { createProduct, deleteProduct, getProducts, updateProduct, uploadProductImage } from "../../shared/api/productsApi";
        ...
        <form className="admin-panel admin-product-form" aria-label="Manage product" onSubmit={handleSubmit}>
          ...
          {formData.image_url && (
            <div className="admin-product-image-preview">
              <img src={resolveAssetUrl(formData.image_url)} alt="Product preview" />
            </div>
          )}
